    ...
    def get_next_questions(self, current_question_key, answer):
        ...
        if current_flow:
            for condition in current_flow.get('conditions', []):
                ...
                if ConditionEvaluator.evaluate_condition(condition['condition'], answer.lower()):
                    print(f'Condición {condition["condition"]} evaluada como verdadera con respuesta {answer}')
